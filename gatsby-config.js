...
module.exports = {
  siteMetadata: {
    ...
    author: `Will Lai`,
    about: `It all started with a diverse group of friends that met weekly for lunch. All from different backgrounds, our love of eclectic food and Boba Tea brought us together.  After one of those lunches, we commented on how there was a lack of these choices in our area and the rest is history. Poké Boba is a fusion of Asian & Latin food culture. Our mission is to offer you a wide range of distinctive food choices in a comfortable, modern setting. `,
